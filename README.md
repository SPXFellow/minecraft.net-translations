...
本目录所收藏的博文翻译来自社区的投稿。如果你对自己翻译的质量有信心，欢迎向本仓库投稿。
...
* **拒绝一切原文发布在 mcbbs.net 的投稿（原文在新闻资讯版发布的除外）。**
* 我们将会收录您的译文链接，读者在浏览时需要访问您提供的译文页面。因此，请确保您的译文发布页面满足以下条件：
  * 可以在中国大陆访问。
  * 不需要注册即可浏览全部内容。
  * 系统不会自动锁定、屏蔽、清理您的译文。
* 如果希望投稿，请在本仓库发起 issue 或 pull request.
* 如果您认为您的译文质量远高于某译文，可以选择提出 issue 来申请替换。
